...
SFont files are 94 character images in a row, also in a single BMP or PNG, in ASCII order.  Letters are variable width, and are separated with magenta gaps (255, 0, 255) in the top row.  The SFont alphabet is as follows:
